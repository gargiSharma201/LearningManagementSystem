		...
		>
			...
			<div class="flex flex-col items-center gap-1">
				<span class="text-lg-medium text-ink-gray-8">
					{{ __('No user enrolled yet') }}
				</span>
				<span class="text-p-base text-ink-gray-6">
					{{ __('Enroll users to track their progress here.') }}
				</span>
			</div>
		</div>
		<div
			...
			<div class="order-1 lg:order-2 space-y-5">
				<AxisChart
					...
					:config="{
						...
						subtitle: __('Progress of users in courses and assessments'),
						xAxis: {
							key: 'task',
							title: 'Tasks',
							type: 'category',
