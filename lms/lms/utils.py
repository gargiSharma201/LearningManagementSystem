...
def get_lesson_attachments(lesson_name: str) -> list:
	"""Return files attached to a Course Lesson."""
		...
		for attachment in attachments:
			if attachment.is_private:
				attachment.download_url = (
					...
					"?file_url=" + quote(attachment.file_url)
				)
			else:
				attachment.download_url = attachment.file_url

		lesson_details.attachments = attachments
